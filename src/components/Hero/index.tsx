...
export const Hero = memo(function Hero({
  ...
  return (
    <div
      className={`w-full pt-20 min-h-fit lg:h-[75vh] flex justify-center sm:items-start md:items-center`}
    >
      <div className="grid w-full sm:grid-cols-1 md:grid-cols-2">
        <div
          className={`w-full h-full flex items-center ${styles.borderDashedB} ${styles.borderDashedR}`}
        >
          <div className={`space-y-4`}>
            <Reveal>
              <div className={cn(`text-xl`, BebasNeue.className)}>
                {PhraseMe}
              </div>
            </Reveal>
            <Reveal>
        ...
        <div
          className={`flex justify-center ${styles.borderDashedL} bg-pattern dark:bg-darkPattern`}
        >
          <Image
